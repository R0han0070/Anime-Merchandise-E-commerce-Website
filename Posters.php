...
session_start();
include 'config.php';
$sql_prod= "SELECT * FROM productdb where pagecode='poster';";
	...
	<div class="row">
		...
		if(mysqli_num_rows($product) > 0){
			while($prod= mysqli_fetch_assoc($product)){
				...
				?>
				<div class="col-4">
					<a href="propage5.php?id=<?php echo  $prod['id'];?>">
					...
					<p><?php echo $prod['product_desc'];  ?></p>
						...
						<form action="pass5.php" method="get">
